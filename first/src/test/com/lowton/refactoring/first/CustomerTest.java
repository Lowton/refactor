...
class CustomerTest {
    ...
    @Test
    void staitment() {
        String johnStatement = "Прокат John\n" +
                "\tRats\t8.0\n" +
                "\tCats\t6.0\n" +
                "Сумма задолженности: 14.0\n" +
                "Вы заработали 3 бонусных очков!\n";
        String aliceStatement = "Прокат Alice\n" +
                "\tDogs\t7.5\n" +
    ...
    @Test
    void htmlStaitmentTest() {
        String johnStatement = "<h1>Прокат <em>John</em></h1>" +
                "<p>Rats: 8.0</p>\n" +
                "<p>Cats: 6.0</p>\n" +
                "<p>Сумма задолженности <em>14.0</em></p>\n" +
                "<p>Вы заработали <em>3</em> бонусных очков.</p>";
        String aliceStatement = "<h1>Прокат <em>Alice</em></h1>" +
                "<p>Dogs: 7.5</p>\n" +
